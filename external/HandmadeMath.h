...
static inline Mat4 Orthographic_RH_NO(float Left, float Right, float Bottom,
...
// coordinates of their respective clipping planes. Near and Far specify the
// distances to the near and far clipping planes.
static inline Mat4 Orthographic_RH_ZO(float Left, float Right, float Bottom,
                                      float Top, float Near, float Far) {
...
// coordinates of their respective clipping planes. Near and Far specify the
// distances to the near and far clipping planes.
static inline Mat4 Orthographic_LH_NO(float Left, float Right, float Bottom,
                                      float Top, float Near, float Far) {
...
// coordinates of their respective clipping planes. Near and Far specify the
// distances to the near and far clipping planes.
static inline Mat4 Orthographic_LH_ZO(float Left, float Right, float Bottom,
                                      float Top, float Near, float Far) {
...
static inline Mat4 Perspective_RH_NO(float FOV, float AspectRatio, float Near,
                                     float Far) {
...
static inline Mat4 Perspective_RH_ZO(float FOV, float AspectRatio, float Near,
                                     float Far) {
...
static inline Mat4 Perspective_LH_NO(float FOV, float AspectRatio, float Near,
                                     float Far) {
...
static inline Mat4 Perspective_LH_ZO(float FOV, float AspectRatio, float Near,
                                     float Far) {
...
static inline Quat NormQ(Quat _Quat) {
  ...
  Vec4 Vec = V4(_Quat.X, _Quat.Y, _Quat.Z, _Quat.W);
  Vec = NormV4(Vec);
  Quat Result = QV4(Vec);
...
static inline Quat M4ToQ_RH(Mat4 M) {
  ...
  if (M.Elements[2][2] < 0.0f) {
    if (M.Elements[0][0] > M.Elements[1][1]) {
      ...
      _Q = Q(T, M.Elements[0][1] + M.Elements[1][0],
      ...
      T = 1 - M.Elements[0][0] + M.Elements[1][1] - M.Elements[2][2];
      _Q = Q(M.Elements[0][1] + M.Elements[1][0], T,
             M.Elements[1][2] + M.Elements[2][1],
             M.Elements[2][0] - M.Elements[0][2]);
    }
  } else {
    if (M.Elements[0][0] < -M.Elements[1][1]) {
      ...
      T = 1 - M.Elements[0][0] - M.Elements[1][1] + M.Elements[2][2];
      _Q = Q(M.Elements[2][0] + M.Elements[0][2],
      ...
      T = 1 + M.Elements[0][0] + M.Elements[1][1] + M.Elements[2][2];
      _Q = Q(M.Elements[1][2] - M.Elements[2][1],
             M.Elements[2][0] - M.Elements[0][2],
...
static inline Quat M4ToQ_LH(Mat4 M) {
  ...
  if (M.Elements[2][2] < 0.0f) {
    ...
    if (M.Elements[0][0] < -M.Elements[1][1]) {
      ...
      T = 1 + M.Elements[0][0] + M.Elements[1][1] + M.Elements[2][2];
      _Q = Q(M.Elements[2][1] - M.Elements[1][2],
             M.Elements[0][2] - M.Elements[2][0],
...
#define Norm(A)                                                                \
  _Generic((A), Vec2: NormV2, Vec3: NormV3, Vec4: NormV4, Quat: NormQ)(A)

#define Dot(A, B)                                                              \
  _Generic((A), Vec2: DotV2, Vec3: DotV3, Vec4: DotV4, Quat: DotQ)(A, B)

#define Lerp(A, T, B)                                                          \
  _Generic((A), float: Lerp, Vec2: LerpV2, Vec3: LerpV3, Vec4: LerpV4)(A, T, B)
